EIFFEL_VERSION := $(shell cat EIFFEL_VERSION)
EIFFEL_DEPS := $(wildcard EIFFEL_*)
DOCKER_TAG_PREFIX := rzuckerm/eiffel:$(EIFFEL_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(EIFFEL_DEPS)
